...
/* package currency-0.2.0.0 */
#ifndef VERSION_currency
#define VERSION_currency "0.2.0.0"
#endif /* VERSION_currency */
#ifndef MIN_VERSION_currency
#define MIN_VERSION_currency(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_currency */

/* package currency-codes-3.0.0.0 */
#ifndef VERSION_currency_codes
#define VERSION_currency_codes "3.0.0.0"
#endif /* VERSION_currency_codes */
#ifndef MIN_VERSION_currency_codes
#define MIN_VERSION_currency_codes(major1,major2,minor) (\
  (major1) <  3 || \
  (major1) == 3 && (major2) <  0 || \
  (major1) == 3 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_currency_codes */
...
#define CURRENT_COMPONENT_ID "first-0.1.0.0-lizjd7IqugDUBsRxbBRxG-first"
