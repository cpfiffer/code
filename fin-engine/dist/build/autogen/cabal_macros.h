...
/* package haskell-contracts-0.1.0.0 */
#define VERSION_haskell_contracts "0.1.0.0"
#define MIN_VERSION_haskell_contracts(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-contracts-0.1.0.0-LkFuMxqIv1w5UN7nhUfxuz"

#define CURRENT_PACKAGE_KEY "haskell-contracts-0.1.0.0-LkFuMxqIv1w5UN7nhUfxuz"
